        ...
        <TabsRoot defaultValue='description'>
          ...
          <TabsContent value='description' className='p-6'>
            ...
            <p className='text-muted-foreground leading-relaxed'>
              Experience crystal-clear audio with our flagship wireless
              headphones. Featuring advanced noise cancellation, 40-hour battery
              life, and premium comfort for all-day wear. Perfect for music
              lovers and professionals who demand the best sound quality.
            </p>
